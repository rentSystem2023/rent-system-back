...
// - 메일 서버 및 기타 메시지 전송 에이전트(NTA)에서 메일 전송, 수신, 중계를 할 때 사용됨
// - 기본포트 : TCP 25
// TLS (Transport Layer Security):
// - 전송 계층 보안
// - 인터넷에서 의사 소통을 위한 개인 정보와 데이터 보안을 위해 사용
// - 서버 간 통신에서 데이터를 암호화하여 전송 및 수신
// - 이메일, 메시지 전송 암호화에 주로 사용됨

@Component
@RequiredArgsConstructor // 다른곳에서 사용하기 위해 의존성 주입
