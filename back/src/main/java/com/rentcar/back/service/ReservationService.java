...
public interface ReservationService {
        ...
        // 예약 취소하기
        ResponseEntity<ResponseDto> patchReservation(PatchReservationStateRequestDto dto, int reservationCode, String userId);

        // 취소 신청 예약 리스트 불러오기
        ResponseEntity<? super GetReservationCancelListResponseDto> getReservationCancelList(String reservationState, String userId);

        // 예약 취소 신청 승인 하기
        ResponseEntity<ResponseDto> patchReservationCancel (PatchReservationStateRequestDto dto, int reservationCode);
        ...
        ResponseEntity<? super GetSearchReservationCarPriceListResponseDto> getSearchReservationCarPriceList(String reservationStart, String reservationEnd, String carName);

        // 차량 예약 상세 검색 결과 불러오기
        ResponseEntity<? super GetSearchReservationDetailListResponseDto> getSearchReservationDetailList(String reservationStart, String reservationEnd, String carName, String rentCompany);
}
